...
class OSIABWebViewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Register WebView globally for script injection support
        com.outsystems.plugins.inappbrowser.osinappbrowser.OSIABWebViewManager.setWebView(webView)
    ...
    override fun onDestroy() {
        // Clear the globally registered WebView
        com.outsystems.plugins.inappbrowser.osinappbrowser.OSIABWebViewManager.clear()
        webView.destroy()
        super.onDestroy()
    }
